...
rcv_topic = "home/groundfloor/kitchen/lights/lightx" #subscribe to messages on this topic
snd_topic = "home/groundfloor/livingroom/lights/lightx" #publish messages to this topic
